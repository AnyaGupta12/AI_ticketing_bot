...
def query_kb(query, company_id):
    ...
    c.execute("SELECT title, content FROM KBDocument WHERE company_id = ?", (company_id,))
    results = c.fetchall()
    ...
    for title, content in results:
        # Simple match count (can improve later)
    ...
    if best_match:
        ...
        return "Sorry, no relevant content found in the knowledge base."
